    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="grid md:grid-cols-2 gap-0 w-full max-w-4xl overflow-hidden rounded-2xl shadow-2xl">
        ...
        <div className="hidden md:flex gradient-hero p-10 flex-col justify-center text-white relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-white/70 leading-relaxed">
              Sign in to access your dashboard, track applications, and discover new remote opportunities.
            </p>
          </div>
        </div>
        ...
        <div className="bg-card p-8 md:p-10">
          <h1 className="text-2xl font-bold mb-1 md:hidden">Welcome Back</h1>
          <h1 className="text-2xl font-bold mb-1 hidden md:block">Sign In</h1>
