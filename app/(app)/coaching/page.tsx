            ...
            <button
              ...
              className={`flex items-start gap-3 p-4 rounded-xl text-left transition-colors ${
                isActive
                  ...
                  : "border border-border bg-card hover:border-amber-200 cursor-pointer"
              }`}
            >
              <span
              ...
              <div className="flex flex-col gap-2 w-full max-w-sm">
                {currentMode.suggestions.map((s) => (
                  <button
                    ...
                    className="text-sm text-left px-4 py-2.5 rounded-lg border border-border bg-card hover:border-amber-300 hover:bg-amber-50 transition-colors"
                  >
                    {s}
                  </button>
                ))}
