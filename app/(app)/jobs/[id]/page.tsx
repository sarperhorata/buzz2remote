        ...
        <div className="flex justify-between items-start mb-6">
          ...
          {hasApplyUrl && (
            <a
              ...
              className="bg-amber-500 hover:bg-amber-600 text-white px-6 py-3 rounded-lg font-medium transition whitespace-nowrap"
            >
              {applyText}
            </a>
          )}
        ...
        {hasApplyUrl && (
          <div className="mt-8 pt-6 border-t dark:border-gray-700">
            <a
              ...
              target={isLoggedIn ? "_blank" : "_self"}
              rel="noopener noreferrer"
              className="bg-amber-500 hover:bg-amber-600 text-white px-8 py-3 rounded-lg font-medium transition inline-block"
            >
