...
function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="shrink-0 text-xs text-gray-500 hover:text-amber-600 border border-gray-200 hover:border-amber-400 px-2.5 py-1 rounded transition-colors"
    >
      {copied ? "Copied!" : "Copy"}
    </button>
  );
        ...
        <div className="mb-8 flex items-start justify-between gap-4">
          ...
          {!isLoading && (
            <button
              ...
              className="shrink-0 bg-white border border-gray-300 text-gray-700 font-medium px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors text-sm"
            >
              Refresh
            </button>
          )}
        ...
        {!isLoading && optimization && (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h2 className="font-bold text-gray-900 text-lg mb-4">✍️ Headline Suggestions</h2>
              <div className="space-y-3">
                {optimization.headline_suggestions.map((headline, i) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-800 flex-1">{headline}</span>
            ...
            <div className="bg-green-50 rounded-xl border border-green-200 p-6">
              <h2 className="font-bold text-gray-900 text-lg mb-4">⚡ Quick Fixes (under 5 min each)</h2>
            ...
            {/* 3. Skills to add */}
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h2 className="font-bold text-gray-900 text-lg mb-4">🛠️ Skills to Add on LinkedIn</h2>
              ...
              <p className="text-xs text-gray-400 mt-3">Click to search on LinkedIn and add to your profile</p>
            </div>

            {/* 4. About section tips */}
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h2 className="font-bold text-gray-900 text-lg mb-4">📝 About Section Tips</h2>
            ...
            <div className="bg-blue-50 rounded-xl border border-blue-200 p-6">
              <h2 className="font-bold text-gray-900 text-lg mb-4">📣 Content Strategy Ideas</h2>
              <div className="space-y-3">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h2 className="font-bold text-gray-900 text-lg mb-4">✅ Profile Completeness Tips</h2>
